...
namespace RestaurantApp3.Classes
{
    ...
    sealed class Server
    {
        ...
        public void Receive(int chickenCount, int eggCount, drinksList drink)
        {
            ...
            {
                IMenuItem DrinkItem;
                int customerCount = tableRequestObject.CustomerCount + 1;
        ...
        public string[] Serve()
        {
            if (tableRequestObject.status == orderStatus.Sent)
            {
                int customerCount = tableRequestObject.CustomerCount;
                string[] customerOrdersList = new string[customerCount + 1];
                ...
                customerOrdersList[customerOrdersList.Length - 1] = "Please enjoy your food!";
